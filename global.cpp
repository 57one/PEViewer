...
INT directoryRVAEditID[] = {
    IDC_EDIT_EXPORT_TABLE_RVA,      IDC_EDIT_IMPORT_TABLE_RVA,
    IDC_EDIT_RESOURCE_TABLE_RVA,    IDC_EDIT_EXCEPTION_TABLE_RVA,
    IDC_EDIT_CERTIFICATE_TABLE_RVA, IDC_EDIT_DEBUG_RVA,
    IDC_EDIT_ARCHITECTURE_RVA,      IDC_EDIT_GLOBAL_PTR_RVA,
    IDC_EDIT_TLS_TABLE_RVA,         IDC_EDIT_LOAD_CONFIG_TABLE_RVA,
    IDC_EDIT_BOUND_IMPORT_RVA,      IDC_EDIT_IAT_RVA,
    IDC_EDIT_DELAY_IMPORT_RVA,      IDC_EDIT_CLR_RUNTIMER_HEADER_RVA,
    IDC_EDIT_RESERVED_RVA,
};

INT directorySizeEditID[] = {
    IDC_EDIT_EXPORT_TABLE_SIZE,      IDC_EDIT_IMPORT_TABLE_SIZE,
    IDC_EDIT_RESOURCE_TABLE_SIZE,    IDC_EDIT_EXCEPTION_TABLE_SIZE,
    IDC_EDIT_CERTIFICATE_TABLE_SIZE, IDC_EDIT_DEBUG_SIZE,
    IDC_EDIT_ARCHITECTURE_SIZE,      IDC_EDIT_GLOBAL_PTR_SIZE,
    IDC_EDIT_TLS_TABLE_SIZE,         IDC_EDIT_LOAD_CONFIG_TABLE_SIZE,
    IDC_EDIT_BOUND_IMPORT_SIZE,      IDC_EDIT_IAT_SIZE,
    IDC_EDIT_DELAY_IMPORT_SIZE,      IDC_EDIT_CLR_RUNTIMER_HEADER_SIZE,
